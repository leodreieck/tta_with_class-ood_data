...
#SBATCH --job-name=norm_final_nodetection                              # Job name #tent_cifar100c_100
...
#SBATCH --time=0-1:00                                                  # Runtime in D-HH:MM
...
#SBATCH --array=2-135                                                  # should match number of corruptions in input txt file

params=($(cat 03_cfgs/hp_final_norm_nodetection.txt | sed ${SLURM_ARRAY_TASK_ID:-1}'q;d') )
