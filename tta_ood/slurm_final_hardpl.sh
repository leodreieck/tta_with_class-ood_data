...
#SBATCH --job-name=hpl_final_breakepochs                            # Job name #tent_cifar100c_100
...
#SBATCH --array=1-30                                                  # should match number of corruptions in input txt file

params=($(cat 03_cfgs/hp_final_breakepochs.txt | sed ${SLURM_ARRAY_TASK_ID:-1}'q;d') )
