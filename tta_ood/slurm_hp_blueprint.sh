...
#SBATCH --job-name=tent_auto1                              # Job name #tent_cifar100c_100
...
#SBATCH --array=24                                                  # should match number of corruptions in input txt file

params=($(cat 03_cfgs/hp_settings_auto1.txt | sed ${SLURM_ARRAY_TASK_ID:-1}'q;d') )
