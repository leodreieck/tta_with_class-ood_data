...
#SBATCH --job-name=gce_final_nodetection                              # Job name #tent_cifar100c_100
...
params=($(cat 03_cfgs/hp_final_gce_nodetection.txt | sed ${SLURM_ARRAY_TASK_ID:-1}'q;d') )
