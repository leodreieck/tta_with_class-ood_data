...
#SBATCH --job-name=tent_final_breakepochs                           # Job name #tent_cifar100c_100
...
#SBATCH --array=17-30                                                  # should match number of corruptions in input txt file
