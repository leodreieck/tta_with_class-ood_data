...
#SBATCH --job-name=tent_ooddetection_lr0.001                           # Job name #tent_cifar100c_100
...
params=($(cat 03_cfgs/hp_settings_ooddetection_lr0.001.txt | sed ${SLURM_ARRAY_TASK_ID:-1}'q;d') )
